var Signup = function () {
    ...
    this.contentTitle = div().css('padding','15px').removeClass('text-center').addClass('text-left').text('Files 3D')
        .css('font-size','38px').css('color','white').css('letter-spacing','10px').css('text-transform', 'uppercase')
        .css('font-family','Open Sans Condensed');
    ...
    this.loginCol = col(6);
    this.signupButton = button('Signup').removeClass('ghost').addClass('cta').css('letter-spacing','6px').css('text-transform', 'uppercase')
        .css('font-family','Open Sans Condensed').css('font-size','16px');
    this.loginButton = button('Login').css('letter-spacing','6px').css('text-transform', 'uppercase')
        .css('font-family','Open Sans Condensed').css('font-size','16px').click(function(){
